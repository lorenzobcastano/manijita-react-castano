        ...
        return (
            ...
            <div className='card w-10/12 m-auto flex flex-row flex-wrap justify-center bg-base-100 shadow-xl'>
                ...
                <div className="text-center w-6/12">
                    ...
                    {onAddStatus ? <NavLink to="/cart" className="btn btn-primary bg-primary w-24 mx-auto">Ir al Carrito</NavLink>:<div><ItemCount stock={item.stock} initial={1} onAdd={(n)=>onAddEvent(n)}/></div> }
